...
@HiltViewModel
class BuyerFirstViewModel @Inject constructor(
    ...
    // 내폰사기
    fun buttonBuyMyPhoneClick(){
        buyerApplication.navHostController.navigate(MainScreenName.MAIN_SCREEN_BUY_LIST.name)

    }
    // 내폰팔기
    fun buttonSellMyPhoneClick(){
